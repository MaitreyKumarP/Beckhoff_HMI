declare namespace TcHmi.Controls.BaseTemplate {
    class TcHmiHeader extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __destroyOnRemovePopup: DestroyFunction[];
        /**
         ...
         */
        protected __onThemeDataChanged(_event: EventProvider.Event): void;
        /**
         ...
         */
        protected __onElementClick(item: TcHmiHeader.IHeaderItems): (_event: EventProvider.Event) => void;
        /**
         ...
         */
        protected __onMouseUp(_event: EventProvider.Event): void;
        /**
