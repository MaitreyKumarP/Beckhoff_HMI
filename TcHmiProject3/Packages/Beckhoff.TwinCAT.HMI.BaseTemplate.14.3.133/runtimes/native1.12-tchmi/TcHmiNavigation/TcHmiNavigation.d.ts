declare namespace TcHmi.Controls.BaseTemplate {
    class TcHmiNavigation extends TcHmi.Controls.System.TcHmiControl {
         ...
         * @param element Element structure
         */
        protected __onMouseUp(element?: TcHmiNavigation.INavigationItem): (_event: MouseEvent | TouchEvent | EventProvider.Event) => void;
        /**
         * Generic 'OnButtonDown'-/ 'onTouchStart' Event Callbackfunction for any Struct-Element-Button
         * @param element Element structure
         */
        protected __onNavButtonDown(element: TcHmiNavigation.INavigationItem): (_event: EventProvider.Event) => void;
        /**
         * Generic 'OnButtonLeave'-/ 'onTouchCancel' Event Callbackfunction for any Struct-Element-Button
         * @param element Element structure
         */
        protected __onNavButtonCancel(element: TcHmiNavigation.INavigationItem): (_event: EventProvider.Event) => void;
        /**
         * Generic 'OnButtonLeave'-/ 'onTouchCancel' Event Callbackfunction for any Struct-Element-Button
         * @param element Element structure
         */
        protected __onNavButtonEnter(element: TcHmiNavigation.INavigationItem): (_event: EventProvider.Event) => void;
        /**
